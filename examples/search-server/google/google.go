...
import (
	...
	"go-concurrency-pattern/examples/search-server/userip"
)
...
func Search(ctx context.Context, query string) (Results, error) {
	...
	// Isseu the HTTP request and handle the response. The httpDo function
...
// httpDo issues the HTTP requests and calls f with the response. If ctx.Done is
